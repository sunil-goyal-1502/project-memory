...
```bash
# Windows
mkdir -p "%APPDATA%\.claude\plugins\cache\project-memory-marketplace"
cp -r project-memory "%APPDATA%\.claude\plugins\cache\project-memory-marketplace\project-memory\0.4.1"

# macOS / Linux
mkdir -p ~/.claude/plugins/cache/project-memory-marketplace
cp -r project-memory ~/.claude/plugins/cache/project-memory-marketplace/project-memory/0.4.1
```
...
Create or update `~/.claude/plugins/cache/project-memory-marketplace/project-memory/.claude-plugin/marketplace.json` to point to the plugin. This file is already included in the repository.
...
1. Remove the plugin from the cache:
   ```bash
   # Windows
   rm -rf "%APPDATA%\.claude\plugins\cache\project-memory-marketplace\project-memory"

   # macOS / Linux
   rm -rf ~/.claude/plugins/cache/project-memory-marketplace/project-memory
   ```
